...
struct thread_data{
    ...
    /**
     * Mutex to be used by the thread.
     */
    pthread_mutex_t *mutex;

    /**
     * Time in milliseconds to wait before obtaining the mutex.
     */
    int wait_to_obtain_ms;

    /**
     * Time in milliseconds to wait while holding the mutex before releasing it.
     */
